...
Go to the Hack Club Slack, and run `/app` to create a app. You'll get asked a few questions:
...
To view a app, simply run `/app <name>`. If you created the app, you'll also have access to some other options:
