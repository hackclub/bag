...
export class Recipe extends Message<Recipe> {
  ...
  /**
   * @generated from field: repeated bag.Item inputs = 6;
   */
  inputs: Item[] = [];

  /**
   * @generated from field: repeated bag.Item outputs = 7;
   */
  outputs: Item[] = [];

  /**
   * @generated from field: repeated bag.Skill skills = 8;
   */
  skills: Skill[] = [];

  /**
   * @generated from field: repeated bag.Item tools = 9;
   */
  tools: Item[] = [];
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 6, name: "inputs", kind: "message", T: Item, repeated: true },
    { no: 7, name: "outputs", kind: "message", T: Item, repeated: true },
    { no: 8, name: "skills", kind: "message", T: Skill, repeated: true },
    { no: 9, name: "tools", kind: "message", T: Item, repeated: true },
  ]);
